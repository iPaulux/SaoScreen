...
s = 1
ep = 1
api.update_profile('Sao Screen ✘','https://twitter.com/Paulgttn' ,'Aincrad - Floor 22', 'Screenshots of SAO anime every 30 minutes in order. Currently on : Saison {} - Ep {} (Probably Spoil and NSFW)'.format(s,ep))
while True:
    screen()
    for b in range(30):
        reply_to_tweets()
    ...
    if e == 50:
        s+=1
        ep = 1
        api.update_profile('Sao Screen ✘','https://twitter.com/PilouBinks' ,'Aincrad - Floor 22', 'Screenshots of SAO anime every 30 minutes in order. Currently on : Saison {} - Ep {} (Probably Spoil and NSFW)'.format(s,ep))
